...
const AddAssignmentPage: React.FC = () => {
  ...
  const handleAddAssignment = async (e: React.FormEvent) => {
    ...
    const newAssignment = {
      assignmentId: '3fa85f64-5717-4562-b3fc-2c963f66afa6', // This is a placeholder value, the actual value will be generated by the server
      assignmentQuestion,
      assignmentCode,
    ...
    <div className="add-assignment-page">
      ...
      <Card>
        ...
        <form className="add-assignment-form" onSubmit={handleAddAssignment}>
          ...
          />
          <Button type="submit" className="upload-button" text="Upload"></Button>
          {message && <p>{message}</p>}
        </form>
      </Card>
    </div>
